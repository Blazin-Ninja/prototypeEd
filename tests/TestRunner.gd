...
func _test_graphics_assets() -> int:
	...
	f += _ok("grass variants present", ResourceLoader.exists("res://assets/tiles/grass_1.png") and ResourceLoader.exists("res://assets/tiles/grass_2.png"))
	f += _ok("tree variants present", ResourceLoader.exists("res://assets/tiles/tree_1.png") and ResourceLoader.exists("res://assets/tiles/tree_2.png"))
	f += _ok("dune variants present", ResourceLoader.exists("res://assets/tiles/dune.png") and ResourceLoader.exists("res://assets/tiles/dune_1.png"))
	f += _ok("cliff tile present", ResourceLoader.exists("res://assets/tiles/cliff.png"))
